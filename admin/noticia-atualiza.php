...
// Capturando o if da notícia por URL dinâmico
$idNoticia = $_GET['id'];
...
if(isset($_POST['atualizar'])){
    ...
    // Lógica/algoritmo para a atualização da imagem (se necessário) :
    ...
    /* Caso contrário, então pegamos a referência (nome/extensão) da nova imagem e fazemos o processo de upload e envio desta referência para o banco de dados. */
        $imagem = $_FILES['imagem']['name'];  //nome.extensão
        upload($_FILES['imagem']);  //envio do arquivo para o servidor
    }
