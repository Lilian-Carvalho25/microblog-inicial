...
if(isset($_POST['inserir'])){
	...
	// Inserir os dados no banco, sendo que no caso da imagem, o banco só irá armazenar o nome dela
...
<div class="row">
	<article class="col-12 bg-white rounded shadow my-1 py-4">
		...
		<!-- Atributo ENCTYPE VALENDO MULTIPART/FORM-DATA é necessário em formulários que receberão arquivos (imagens, documentos, pdfs, planilhas) para processamento. -->
